...
choice1 = input('You are at a crossroad, where do '
                'want to go? "Left" or "Right" ').lower()

if choice1 == "left":
    choice2 = input("You've come to a lake, there is an island in the middle of the lake. "
                    "Type 'wait' to wait for a boat or type ''").lower()
    ...
    if choice2 == "wait":
        ...
        if choice3 == "red":
            print("Its the room full of fire. Game Over!!")
